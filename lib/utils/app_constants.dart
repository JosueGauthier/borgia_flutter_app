...
class AppConstants {
  ...
  static const String OPERATOR_MODULE_URI =
      "/api-links/shops/operatorsale-modules/";
  ...
  static const String CATEGORY_URI =
      "/api-links/self-sale-list/category/?shop_id=";

  static const String SEARCH_SHOP_URI = "/api-links/searchshop/?search=";
  static const String SEARCH_CATEGORY_URI =
      "/api-links/searchcategory/?search=";
  ...
  static const String PRODUCT_URI_NAME =
      "/api-links/shops/productsv2/?name="; //via name
  static const String PRODUCT_URI_ID =
      "/api-links/shops/productsv2/?id="; //via id

  //* Lydia uri
  static const String LYDIA_DO_REQUEST_URI = "/api-links/lydia/";
  static const String LYDIA_STATE_REQUEST_URI =
      "/api-links/lydia-state-request/";

  //* Stat uri
  static const String YEAR_SALELIST_URI = "/api-links/history/";
  static const String HOUR_SALELIST_URI = "/api-links/live-sales/";
  static const String USER_SALELIST_URI =
      "/api-links/sale/user-history-allsale/?username=";

  static const String SHOP_STAT_URI = "/api-links/shops/shop-stat/";
  static const String USER_SHOP_STAT_URI =
      "/api-links/sale/stat-user/?username=";
  static const String RANK_USER_SHOP_STAT_URI =
      "/api-links/sale/rank-user-shop/";
  static const String RANK_USER_URI = "/api-links/sale/rank-user/";
  static const String RANK_USER_PRODUCT_STAT_URI =
      "/api-links/sale/rank-user-product/?id=";
  ...
  static const String PRODUCT_LIST_URI_FROM_SHOP =
      "/api-links/shops/products/?shop=";
  ...
  static CloudinaryPublic CLOUDINARY_PUBLIC_VAR =
      CloudinaryPublic('dxsy9rszs', 'borgia', cache: false);

  static const String APP_NAME = "BorgiaApp";
  static const int APP_VERSION = 1;
  static const String BASE_URL = "https://borgia.boquette.fr";
